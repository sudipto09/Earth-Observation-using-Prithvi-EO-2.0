...
import os
#config
DATE_FOLDERS  = ['2024-04-23', '2024-05-13', '2024-06-17', '2024-07-14', '2024-08-16', '2024-09-15']
PATCH_ID = '32UNA_3_4'
...
if not selected:
    ...
    for current_date in DATE_FOLDERS:
        ...
        if ds is None:
            ...
            continue # Skip to the next date instead of failing
        ...
        try: 
            ...
            print(f"Extracting {CHIP_SIZE}×{CHIP_SIZE} chip from {current_date}...")
            ...
            #save chip
            filename  = f"prithvi_input_FID{field.id()}_{current_date}.npy"
            ...
            mask_path = os.path.join(OUTPUT_PATH, f"prithvi_mask_FID{field.id()}_{current_date}.npy")
